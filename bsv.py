...
# 시작 메세지 슬랙 전송
post_message(myToken, "#flex", "autotrade start")
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_buy_price > current_price:
                ...
                if BSV > 0:
                    ...
                    post_message(myToken, "#flex", "BSV Sell : " + str(sell_result))
                else:
                    pass
            else:
                pass
